...
class MobileSession(BaseSession):
    ...
    def __init__(self, platform, config):
        ...
        self._logger.info(f"Session Created for Platform: {self.platform}")

    def launch_app(self):
        self._logger.info("Launching Nanit App...")
        self.current_screen = "WelcomeScreen"

    def find_element(self, element_id):
        self._logger.info(f"Finding element: {element_id}")
